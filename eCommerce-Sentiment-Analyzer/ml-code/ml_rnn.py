...
for hidden_size, embed_size, learning_rate in product(hidden_sizes, embed_sizes, learning_rates):
    ...
    model = TextRNN(vocab_size, embed_size, hidden_size, num_classes)
...
}, 'best_text_rnn_model_with_params.pth')
...
sensitivity = true_positives / (true_positives + false_negatives + 1e-10)  # Bölme hatasını önlemek için 1e-10 ekledik
